...
export const metadata = {
  title: "Acqyrly",
  description: "Acqyrly provides the tools and insights you need to make informed decisions and accelerate your acquisition process. Start your journey today.",
};
