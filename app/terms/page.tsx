  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-10">
      ...
      <div className="mt-4 space-y-3 text-sm text-brand-slate-700">
        <p>Acquirely by Starting Gate Financial is for informational purposes only and is not financial, legal, or tax advice. Verify results before making decisions.</p>
