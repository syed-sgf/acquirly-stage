    ...
    <div className="sticky top-0 z-50 bg-white/90 backdrop-blur border-b">
      <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm">
          ...
          <Link href="/core" className="rounded-lg bg-brand.green-600 text-white px-3 py-1.5 font-medium shadow-soft hover:brightness-95" aria-label="Start Free with Core">
